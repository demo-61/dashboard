...
const LoginPage: React.FC<LoginPageProps> = ({ onLogin }) => {
  ...
  return (
    <div className={`sm:min-h-screen sm:mt-0 mt-4 flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 ${fontFamilyClass} ${language === 'ar' ? 'rtl' : 'ltr'}`}>
